...
return new class extends Migration
{
    ...
    {
        // AFTER INSERT validation trigger for attendances
        // Enforces basic data integrity rules at database level.
        // Note: Requires MySQL.

        DB::unprepared(<<<SQL
        DROP TRIGGER IF EXISTS attendance_after_insert_validate;
        SQL);
        ...
        FOR EACH ROW
        BEGIN
            -- time_in should be less than or equal to time_out when time_out exists
            ...
            -- If has_excuse is true, status must be excused (optional rule)
